...
public class TablesNamesFinder implements SelectVisitor, FromItemVisitor, ExpressionVisitor, ItemsListVisitor, SelectItemVisitor, StatementVisitor {
     ...
     * @return
     */
    public Map<String,List<String>> getTableList(Statement statement) {
        init();
        tables = new HashMap<String, List<String>>();
        tables.put("SELECT", new LinkedList<String>());
        tables.put("DELETE", new LinkedList<String>());
        tables.put("CREATE", new LinkedList<String>());
        tables.put("MERGE", new LinkedList<String>());
        tables.put("UPDATE", new LinkedList<String>());
        tables.put("INSERT", new LinkedList<String>());
        tables.put("REPLACE", new LinkedList<String>());
        tables.put("UPSERT", new LinkedList<String>());
     ...
     * @return
     */
    public Map<String,List<String>> getTableList(Expression expr) {
        init();
        expr.accept(this);
        return tables;
    }
    ...
    public void visit(Table tableName) {
        ...
        String val = operation.pop();
        operation.push(val);
        if (!otherItemNames.contains(tableWholeName.toLowerCase())
                && !tables.get(val).contains(tableWholeName)) {
        	tables.get(val).add(tableWholeName);
        }
    }
    ...
    public void visit(Column tableColumn) {
    	//this looks interesting to let information include also columns
    }
    ...
    public void visit(Delete delete) {
        ...
        tables.get("DELETE").add(delete.getTable().getName());
    ...
    public void visit(Update update) {
        ...
        for (Table table : update.getTables()) {
            tables.get("UPDATE").add(table.getName());
        }
    ...
    public void visit(Insert insert) {
        ...
        tables.get("INSERT").add(insert.getTable().getName());
    ...
    public void visit(Replace replace) {
    	...
    	tables.get("REPLACE").add(replace.getTable().getName());
    ...
    public void visit(CreateTable create) {
        ...
        tables.get("CREATE").add(create.getTable().getFullyQualifiedName());
    ...
    public void visit(Merge merge) {
        ...
        tables.get("MERGE").add(merge.getTable().getName());
    ...
    public void visit(Upsert upsert) {
        ...
        tables.get("UPSERT").add(upsert.getTable().getName());
